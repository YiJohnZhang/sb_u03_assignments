...
const {Companies, Invoices, Industries} = require('../models');
...
const requestIndustriesResourceExists = async(req, res, nxt) => {

    const objectExists = await Industries.confirmModelByPK(req.params.id);
