  /**	`pgModels.js`. A lightweight library built on top of a native raw SQL, `node-pg` to provide support to some ORM features. Built by Yi J. Zhang.
	...
	*	Version History
    *   ===============
	*	Version 02: Current Version. Cleaning up comments and documentation. Renamed to `pgModels` as a temporary name placeholder
    ...
    *       - Always: constructor(), validateConstructedObject(), __repr()__ (if debugging), static destructureObjectProperties(), static confirmModelByPK(), static returnModelByPK(), static deleteModelByPK()
...
//  =====================================
const {RESPONSE_MESSAGE_MAPPING} = require('../modules/utilities')
